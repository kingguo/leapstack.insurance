package com.leapstack.insurance.common.api

import akka.http.scaladsl.server.Directives._
import akka.http.scaladsl.testkit.ScalatestRouteTest
import com.leapstack.insurance.common.api.`X-Content-Type-Options`.`nosniff`
import com.leapstack.insurance.common.api.`X-Frame-Options`.`DENY`
import com.leapstack.insurance.common.api.`X-XSS-Protection`.`1; mode=block`
