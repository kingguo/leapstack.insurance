...
import com.leapstack.insurance.common.Utils
import com.leapstack.insurance.email.application.{EmailService, EmailTemplatingEngine}
...
import com.leapstack.insurance.user.application.UserDao
